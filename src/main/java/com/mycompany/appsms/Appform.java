...
public class Appform extends javax.swing.JFrame 
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pilih Operator Pulsa");
        ...
        Nominal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "5000", "10000", "20000", "25000", "50000", "100000" }));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(Operator, javax.swing.GroupLayout.PREFERRED_SIZE, 0, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(24, 24, 24)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jLabel4.setText("FORM PEMBELIAN PULSA SIPULsa");
        ...
        if(json.get("type").getAsString().equals("success")){
            ...
            try{java.sql.Statement statement = Koneksi.getConnection().createStatement();
                statement.executeUpdate("INSERT INTO tbl_transaksi(nama_produk, jenis_produk, Nominal, nomor, status) "
                        + "VALUES('"+operator+"','Pulsa', '"+nominal+"', '"+nomor+"', 'Sukses')");
                statement.close();
                ...
                statement.executeUpdate("INSERT INTO tbl_transaksi(nama_produk, jenis_produk, Nominal, nomor, status, keterangan) "
                        + "VALUES('"+operator+"','Pulsa', '"+nominal+"', '"+nomor+"', 'Gagal', '"+msg+"')");
                statement.close();
